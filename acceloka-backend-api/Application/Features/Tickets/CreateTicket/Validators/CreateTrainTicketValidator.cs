...
public class CreateTrainTicketValidator : AbstractValidator<CreateTrainTicketCommand>
{
    public CreateTrainTicketValidator()
    {
        ...
        RuleFor(t => t.TrainCode).NotEmpty().WithMessage("Train code is required!");
        RuleFor(t => t.TrainType).NotEmpty().WithMessage("Train type is required!");
        RuleFor(t => t.SeatClass).NotEmpty().WithMessage("Seat class is required!");
        RuleFor(t => t.DepartureStation).NotEmpty().WithMessage("Departure station is required!");
        RuleFor(t => t.ArrivalStation).NotEmpty().WithMessage("Arrival station is required!");
