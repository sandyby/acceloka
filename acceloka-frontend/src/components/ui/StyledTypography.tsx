...
const StyledTypography = styled(Typography, {
    ...
    color: colorInput === "primary" ? "var(--color-primary-500)" : colorInput === "secondary" ? "var(--color-secondary-900)" : colorInput === "accent" ? "var(--color-accent-secondary-900)" : "var(--color-white-900)",
