...
export default function StyledSeaTransportationTicketCard({ ticket }: { ticket: ISeaTransportationTicket }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md border border-gray-200 overflow-clip h-full flex flex-col md:flex-row hover:border-primary-300 transition-colors group">
      <div className="flex-[2] p-5 min-w-0 overflow-hidden">
        <div className="flex items-center gap-3 mb-4 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex gap-x-2 items-center">
              <Tooltip title="Transportation Type" arrow placement='top' slotProps={{
                tooltip: {
                  sx: {
              ...
              <Tooltip title={`Company: ${ticket.company}`} arrow placement='top' slotProps={{
                tooltip: {
                  sx: {
                    bgcolor: "var(--color-primary-500)",
                    color: "var(--color-white-900)",
        ...
        <div className="flex items-center justify-between bg-gray-50 p-4 rounded-xl border border-gray-100 min-w-0">
          <div className="text-center w-70 min-w-0">
            ...
            <p title={ticket.departurePort} className="text-xl font-black text-secondary-900 line-clamp-2 leading-[1.2] max-h-[2.4em] break-all">
          ...
          <div className="text-center w-70 min-w-0">
            ...
            <p title={ticket.arrivalPort} className="text-xl font-black text-secondary-900 line-clamp-2 leading-[1.2] max-h-[2.4em] break-all">
              {ticket.arrivalPort}
            </p>
            <p className="text-sm text-primary-500 font-medium mt-1">
        ...
        <div className="mt-4 flex items-center gap-2">
          <Tooltip title="Seat Class" arrow placement='top' slotProps={{
            tooltip: {
              sx: {
                bgcolor: "var(--color-primary-500)",
                color: "var(--color-white-900)",
