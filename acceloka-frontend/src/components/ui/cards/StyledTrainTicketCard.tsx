...
export default function StyledITrainTicketCard({ ticket }: { ticket: ITrainTicket }) {
    ...
    return (
        <div className="relative bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl shadow-md overflow-hidden h-60 border border-cyan-200">
            <div className="absolute inset-y-0 right-1/3 w-px bg-cyan-300">
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-10 h-10 rounded-full bg-cyan-100 flex items-center justify-center text-xl">
                    🚄
                </div>
                <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-10 h-10 rounded-full bg-cyan-100 flex items-center justify-center text-xl">
                    🚉
                </div>
            </div>
            ...
            <div className="grid grid-cols-[3fr_1fr_3fr] h-full p-5 gap-4">
                <div className="flex flex-col justify-between">
                    <div>
                        ...
                        <StyledTypography variant="subtitle2" className="text-cyan-700 mt-1">
                            {ticket.trainCode} • {ticket.trainType}
                        </StyledTypography>
                        ...
                        <div className="flex flex-wrap gap-2 mt-3 capitalize">
                            ...
                            <span className="px-3 py-1 bg-cyan-600 text-white text-xs rounded-full">
                                {ticket.seatClass}
                            </span>
