            ...
            <div className="flex-[2] p-5 min-w-0 overflow-hidden">
                <div className="flex items-center gap-3 mb-4 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex gap-x-2 items-center">
                            <Tooltip title="Bus Type" arrow placement='top' slotProps={{
                                tooltip: {
                                    sx: {
                            ...
                            <Tooltip title={`Bus Code: ${ticket.busCode}`} arrow placement='top' slotProps={{
                                tooltip: {
                                    sx: {
                                        bgcolor: "var(--color-primary-500)",
                                        color: "var(--color-white-900)",
                ...
                <div className="flex items-center justify-between bg-gray-50 p-4 rounded-xl border border-gray-100 min-w-0">
                    <div className="text-center w-70 min-w-0">
                        ...
                        <p title={ticket.departureStop} className="text-xl font-black text-secondary-900 line-clamp-2 leading-[1.2] max-h-[2.4em] break-all">
                    ...
                    <div className="text-center w-70 min-w-0">
                        ...
                        <p title={ticket.arrivalStop} className="text-xl font-black text-secondary-900 line-clamp-2 leading-[1.2] max-h-[2.4em] break-all">
                            {ticket.arrivalStop}
                        </p>
                        <p className="text-sm text-primary-500 font-medium mt-1">
